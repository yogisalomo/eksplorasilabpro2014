...
<html lang="en">
	<head>
		...
		<!-- Bootstrap core CSS -->
		<link href="<?php echo URL::base(); ?>media/css/bootstrap.css" rel="stylesheet">
		<link href="<?php echo URL::base(); ?>media/css/jquery-ui.min.css" rel="stylesheet">
	...
	<script src="<?php echo URL::base(); ?>media/js/jquery.min.js"></script>
	<script src="<?php echo URL::base(); ?>media/js/bootstrap.min.js"></script>
	<script src="<?php echo URL::base(); ?>media/js/jquery-ui.min.js"></script>
